 ...
 *
 * پالت رنگ هم‌خانوادهٔ نظام بصری برنامه است (جوهر، برنج، سبز، شنگرف) ولی
 * روشن‌تر و پرمایه‌تر از رنگ‌های متن — چون علامت نمودار باید روی کاغذ سفید
 * دیده شود، نه اینکه خاکستری بخواند. با scripts/validate_palette.js روی سطح
 * سفید کارت‌ها اعتبارسنجی شده است:
 *   categorical (۵ اسلات، مجاور)  → همهٔ بررسی‌ها PASS
 *   ordinal ۵ پلهٔ برنجی           → همهٔ بررسی‌ها PASS
 */
(function (w) {
  'use strict';
  ...
  var C = {
    ...
    series: ['#4C5BC0', '#B9832A', '#1F8A6B', '#C24630', '#8A4BA8'],
    // ترتیب (مرحلهٔ قیف، سطل سنی) — یک رنگ برنجی، روشن به تیره
    ordinal: ['#D7B26A', '#C2913C', '#A6741B', '#855A12', '#5E3F0A'],
    // وضعیت — معنای رزرو‌شده، همیشه با آیکن و برچسب
    status: { good: '#1F8A6B', warning: '#B9832A', serious: '#C4632A', critical: '#C24630' },
    surface: '#ffffff',
    grid: '#E7E3D9',
    axis: '#CFC9BA',
    muted: '#7C7768',
