...
(function (w) {
  ...
  var KINDS_DEFAULT = [
    'نامهٔ وارده', 'نامهٔ صادره', 'گزارش بازرسی', 'دعوت‌نامهٔ جلسه',
    'دفاعیهٔ کتبی', 'استعلام حراست', 'پاسخ حراست', 'صورت‌جلسهٔ کمیته',
    'رأی کمیته', 'نامهٔ ابلاغ رأی', 'بازگشت ابلاغ', 'حکم کارگزینی',
    'مدارک هویتی', 'سایر'
  ];
