...
EXTRA_FIELDS = [
    ...
    # تاریخ استخدام: «سابقهٔ کار» از روی همین حساب می‌شود، هم کنار خود
    # فیلد و هم در فرم‌های اداری. عددی که تا امروز دستی نوشته می‌شد.
    ('hireDate', 'تاریخ استخدام', 'date', 'job'),
